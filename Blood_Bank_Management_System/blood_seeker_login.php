...
<body>
    <div class="container">
        <div class="row justify-content-center mt-5">
            <h3 class="text-center fw-bold mb-4">Blood Seeker Login </h3>
            <?php
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $sql="SELECT * FROM blood_seeker_registration WHERE  username='$username' AND password='$password'";
    $result=$conn->query($sql);
    if($result->num_rows>0){
        // echo "login successfully";
        $_SESSION["username"]=$username;
        header("location:blood_seeker.php");
...
?>
            <div class="col-md-6 col-lg-5 bloodSeekerlogin p-4 rounded shadow">
                <form method="post">
                    ...
                    <h6 class="text-center mt-3">New User? <a href="blood_seeker_register.php" class="text-danger">Register as Blood Seeker</a></h6>
                </form>
            </div>
        </div>
    </div>
