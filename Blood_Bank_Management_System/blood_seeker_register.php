...
<head>
    ...
    <title>Blood Seeker Registration</title>
...
<body>
    <div class="container">
        <div class="row justify-content-center mt-5">
            <div class="col-md-6">
                <h3 class="text-center fw-bold mb-3">Blood Seeker Registration</h3>
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $check_email_sql = "SELECT * FROM blood_seeker_registration WHERE email='$email'";
                    $check_username_sql = "SELECT * FROM blood_seeker_registration WHERE username='$username'";
                    ...
                    if ($email_result->num_rows > 0) {
                    ...
                    else if ($username_result->num_rows > 0) {  // Fixed issue here
                        echo '<div class="alert alert-danger text-center fw-bold p-2 mb-3" role="alert">
                        ...
                        $sql = "INSERT INTO blood_seeker_registration(email, username, password) VALUES('$email','$username','$password')";
                ...
                <div class="p-4 rounded shadow bg-white">
                    <form method="post">
                        ...
                        <h6 class="text-center mt-3">Already have an Account? 
                            <a href="blood_seeker_login.php" class="text-danger">Login as Blood Seeker</a>
                        </h6>
                    </form>
                </div>
            </div>
