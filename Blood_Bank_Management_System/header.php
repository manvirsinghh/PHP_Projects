    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="text-center">
          ...
          if (isset($_SESSION["username"])) {
            echo '
            <a class="btn btn-custom text-white me-2" style="background-color: #FF4444;" href="detail_dashboard.php">Dashboard</a>
            <a class="btn btn-custom text-white" style="background-color: #FF4444;" href="emergency_details_fetch.php">Emergency</a>';
          } else {
            echo '
