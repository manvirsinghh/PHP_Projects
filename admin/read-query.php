    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="p-3">
                    <div class="dashboard-header mt-3">ADMIN | MANAGE READ QUERIES</div>
                    <div class="breadcrumb-text d-flex justify-content-end">Admin / Read Queries</div>

                    <!-- <div class="footer-text">HOSPITAL MANAGEMENT SYSTEM</div> -->
                </div>
                <div class="container">
                    <span>Manage: <span>Read Queries</span></span>
